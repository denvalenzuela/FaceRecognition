...
def train_img(frame,profilename):
    ...
    try:
        num_of_face_saved = len([name for name in os.listdir("mainapp/face_profiles/"+profilename+"/")])+1
    except:
        os.makedirs("mainapp/face_profiles/"+profilename)
        num_of_face_saved = len([name for name in os.listdir("mainapp/face_profiles/"+profilename+"/")])+1
    ...
    #     exit()
    # else: 
    profile_folder_path = ut.create_profile_in_database(profilename)
