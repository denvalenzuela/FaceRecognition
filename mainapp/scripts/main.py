...
import mainapp.scripts.utils as ut
from mainapp.scripts import svm
import sys
import logging
import warnings
...
def rec_img(frame):
    ...
    face_profile_data, face_profile_name_index, face_profile_names  = ut.load_training_data("mainapp/face_profiles/")
    ...
    face_cascade = cv2.CascadeClassifier("mainapp/classifier/haarcascade_frontalface_default.xml") #create a cascade classifier
    sideFace_cascade = cv2.CascadeClassifier('mainapp/classifier/haarcascade_profileface.xml')
    ...
    print("SCALE_FACTOR",(frame_scale))
    cropped_face = []
    num_of_face_saved = 0
...
#         break
    ...
    # resized_frame = cv2.resize(img, (400, 600))
